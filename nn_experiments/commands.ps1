...
python mnist_launch.py --exp_root=mnistexperiments --exp_name=0002-smallbatch --simple=True --lr=0.000645 --weight_decay=5.687505e-05 --batch_size=20
python mnist_launch.py --exp_root=mnistexperiments --exp_name=0003-smallbatch --simple=True --lr=0.000645 --weight_decay=5.687505e-05 --batch_size=20
python mnist_launch.py --exp_root=mnistexperiments --exp_name=0004-smallbatch --simple=True --lr=0.000645 --weight_decay=5.687505e-05 --batch_size=20
...
python mnist_launch.py --exp_root=mnistexperiments --exp_name=0000-diffsample --simple=True --lr=0.000934 --weight_decay=1.254031e-06 --keep_frac=0.1 --sparse=True  --full_random=True
python mnist_launch.py --exp_root=mnistexperiments --exp_name=0001-diffsample --simple=True --lr=0.000934 --weight_decay=1.254031e-06 --keep_frac=0.1 --sparse=True  --full_random=True
python mnist_launch.py --exp_root=mnistexperiments --exp_name=0002-diffsample --simple=True --lr=0.000934 --weight_decay=1.254031e-06 --keep_frac=0.1 --sparse=True  --full_random=True
